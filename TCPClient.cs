...
namespace GameClient
{
    ...
    public class TCPClient
    {
        ...
        public bool Connect(string ip, int port)
        {
            ...
            {
                // 每10秒对其中一个字典进行检测
                timerConnectTimeout = new System.Timers.Timer(15 * 1000);
        ...
        private void SocketConnected(IAsyncResult iar)
        {
            try
            {
                ...
                _Socket.BeginReceive(mReceiveBuffer, 0, mReceiveBuffer.Length, SocketFlags.None, new AsyncCallback(SocketReceived), mReceiveBuffer);
