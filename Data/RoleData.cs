...
namespace GameClient.Data
{
    ...
    public class RoleData
    {
        ...
        /// <summary>
        /// Thông số hàng ngày được lưu ở database
        /// </summary>
        [ProtoMember(76)]
        public DailyDataRecore DailyDataRecore { get; set; } = new DailyDataRecore();

        /// <summary>
        /// Thông số hàng tuần được lưu ở database
        /// </summary>
        [ProtoMember(77)]
        public WeekDataRecore WeekDataRecore { get; set; } = new WeekDataRecore();

        /// <summary>
        /// Thông số được lưu vĩnh viễn ở database
        /// </summary>
        [ProtoMember(78)]
        public ForeverRecore ForeverRecore { get; set; } = new ForeverRecore();
