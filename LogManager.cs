...
namespace GameClient
{
    ...
    public class LogManager
    {
        ...
        public static bool EnableDbgView = true;
        ...
        public static string ExceptionPath
        {
            get
            {
                lock (mutex)
                {
                    ...
                    {
                        _ExceptionPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Exception");
        ...
        private static void WriteLog(string logFile, string logMsg)
        {
            try
            {
                string logPath = Path.Combine(LogPath, logFile + "_" + DateTime.Now.ToString("yyyyMMdd") + ".log");
